...
const panelClassName =
  "rounded-2xl border border-lime-200 bg-white p-6 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md dark:border-teal-700 dark:bg-teal-950/80";

const insetClassName =
  "rounded-lg border border-lime-100 bg-lime-50/40 p-3 dark:border-teal-800 dark:bg-teal-900/30";
