...
export function LandingBanner() {
  ...
  return (
    <main className="flex flex-1">
      <section className="flex w-full flex-1 border-t border-lime-300 bg-white px-4 text-black shadow-[0_16px_45px_-24px_rgba(15,23,42,0.18)] sm:border-y sm:px-6 lg:px-8 dark:border-teal-700 dark:bg-teal-950/70 dark:text-teal-100 dark:shadow-[0_16px_45px_-24px_rgba(16,185,129,0.25)]">
